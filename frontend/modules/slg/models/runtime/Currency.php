 ...
 */
class Currency extends RuntimeActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            [['id'], 'required'],
            [['id', 'level', 'vipLevel', 'currencyNum', 'beforeNum', 'remainNum', 'deviceType', 'serverId', 'sex', 'network', 'logTime'], 'integer'],
            [['appId'], 'string', 'max' => 16],
            ...
            [['roleName', 'currencyType', 'action', 'deviceName', 'systemName'], 'string', 'max' => 125],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'currencyType' => Yii::t('app', '货币唯一标示'),
            'currencyNum' => Yii::t('app', '获得/消耗货币数量'),
