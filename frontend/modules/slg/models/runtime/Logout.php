...
/**
 * This is the model class for table "{{%logout}}".
 *
 * @property string $id
 ...
 */
class Logout extends RuntimeActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            [['id'], 'required'],
            [['id', 'level', 'vipLevel', 'deviceType', 'serverId', 'sex', 'network', 'onlineTime', 'loginTime', 'logTime'], 'integer'],
            [['appId'], 'string', 'max' => 16],
    ...
    /**
     * @inheritdoc
     * @return LogoutQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new LogoutQuery(get_called_class());
    }
}
