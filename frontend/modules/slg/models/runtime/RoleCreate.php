...
/**
 * This is the model class for table "{{%roleCreate}}".
 *
 * @property string $id
 ...
 */
class RoleCreate extends RuntimeActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return RoleCreateQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new RoleCreateQuery(get_called_class());
    }
}
