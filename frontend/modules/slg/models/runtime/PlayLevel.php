...
/**
 * This is the model class for table "{{%playLevel}}".
 *
 * @property string $id
 ...
 */
class PlayLevel extends RuntimeActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            [['id'], 'required'],
            [['id', 'level', 'vipLevel', 'duration', 'success', 'deviceType', 'serverId', 'sex', 'network', 'logTime'], 'integer'],
            [['appId'], 'string', 'max' => 16],
            ...
            [['roleName', 'levelId', 'deviceName', 'systemName'], 'string', 'max' => 125],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'levelId' => Yii::t('app', '任务唯一标示'),
            'duration' => Yii::t('app', '任务耗时(秒)'),
            'success' => Yii::t('app', '任务状态 0:失败 1:成功'),
    ...
    /**
     * @inheritdoc
     * @return PlayLevelQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new PlayLevelQuery(get_called_class());
    }
}
